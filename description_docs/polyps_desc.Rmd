...
## Polyps Dataset Introduction and Codebook
...
|Position| Variable| Variable Label| Units| Value Codes| Variable Type|
|--------|---------|---------------|------| ---------| ---|
|1|participant_id|Participant ID|NA|NA|character|
|2|sex|Sex|NA|male, female|factor|
|3|age|Age|years|NA|numeric|
|4|baseline|Number of Polyps at Baseline|NA|NA|numeric|
|5|treatment|Treatment Assigned|NA|sulindac, placebo|factor|
|6|number3m|Number of Polyps at 3 Months|NA|NA|numeric|
|7|number12m|Number of Polyps at 12 Months|NA|NA|numeric}
