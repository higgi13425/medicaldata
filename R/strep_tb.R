...
#'   \item{dose_strep_g}{grams, dose of Streptomycin: numeric, 0, 1, or 2 grams}
...
#'   \item{baseline_condition}{Condition of the Patient at Baseline, 3 levels, 1_Good, 2_Fair, 3_Poor; type: factor}
#'   \item{baseline_temp}{temperature at baseline in degrees fahrenheit or celsius, but categorized into 4 levels (afebrile level apparently were cases not measured with a thermometer): factor, with levels: 1_<99F/37.2C, 2_99-99.9F/37.3-37.8C, 3_100-100.9F/37.9-38.3C, 4_>=101F+/38.4C}
