...
#'
#' This study evaluated gastric emptying, small bowel transit time, and total intestinal transit time in 8 critically ill trauma patients. These data were compared with those obtained in 87 healthy volunteers from a separate trial. Data were obtained with a motility capsule that wirelessly transmitted pH, pressure, and temperature to a recorder attached to each subject’s abdomen. Transit times were available for almost all patients, however, pH, pressure and temperature data is missing for all critically ill patients and sparsely missing for the healthy volunteers. \cr
#' The Smart Pill dataset was contributed by Dr. Amy Nowacki, Associate Professor, Cleveland Clinic. Please refer to this resource as: Amy S. Nowacki, “Smart Pill Dataset”, TSHS Resources Portal (2017). Available at https://www.causeweb.org/tshs/smart-pill/. \cr
...
#' \item{\code{C.Time}}{Colonic Transit Time is time from ileocecal junction to body exit (hours), numeric, range:   0.7-118.9}
#' \item{\code{WG.Time}}{Whole Gut Time is time from ingestion to body exit (hours), numeric, range:   6.0-816.0}
#' \item{\code{S.Contractions}}{Stomach contractions are counted if the peak amplitude of the contraction is over 10 mmHg and under 300 mmHg, numeric, range:  47.0-1665.0}
#' \item{\code{S.Sum.of.Amplitudes}}{Stomach sum of amplitudes (mm Hg), numeric, range: 655.6-33800.3}
#' \item{\code{S.Mean.Peak.Amplitude}}{Stomach mean peak amplitude is the sum of amplitudes divided by number of contractions (mm Hg), numeric, range:   4.6-43.4}
#' \item{\code{S.Mean.pH}}{Stomach mean pH is the average pH over the whole recording time in the stomach with normal ~ 1.5-3.5, numeric, range:   1.5-5.9}
#' \item{\code{SB.Contractions}}{Small Bowel contractions are counted if the peak amplitude of the contraction is over 10 mmHg and under 300 mmHg, numeric, range: 223.0-2375.0}
#' \item{\code{SB.Sum.of.Amplitudes}}{Small Bowel sum of amplitudes (mm Hg), numeric, range:3899.4-41122.5}
#' \item{\code{SB.Mean.Peak.Amplitude}}{Small Bowell mean peak amplitude is the sum of amplitudes divided by number of contractions (mm Hg), numeric, range:  15.0-27.9}
#' \item{\code{SB.Mean.pH}}{Small Bowel mean pH is the average pH over the whole recording time in the small bowel, normal ~ 6-7.4, numeric, range:   4.7-8.6}
#' \item{\code{Colon.Contractions}}{Colon contractions are counted if the peak amplitude of the contraction is over 10 mmHg and under 300 mmHg, numeric, range:  41.0-2672.0}
#' \item{\code{Colon.Sum.of.Amplitudes}}{Colon sum of amplitudes (mm Hg), numeric, range:1872.6-117707.5}
#' \item{\code{C.Mean.Peak.Amplitude}}{Colon mean peak amplitude is the sum of amplitudes divided by number of contractions (mm Hg), numeric, range:  32.8-    64.2}
#' \item{\code{C.Mean.pH}}{Colon mean pH is the average pH over the whole recording time in the colon, normal ~ 5-7-6.7, numeric, range:   3.9-8.1}
#' }
#'
