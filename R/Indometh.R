...
#'
#' @description
#' Results of a Cohort Study of the Pharmacokinetics of Intravenous Indomethacin, with plasma concentrations over time (**more details** available below the variable definitions). \cr
#' @details
