...
#' \cr
#' Source: \cr
#' Sobecks et al. “Cytomegalovirus Reactivation After Matched Sibling Donor Reduced- Intensity Conditioning Allogeneic Hematopoietic Stem Cell Transplant Correlates With Donor Killer Immunoglobulin-like Receptor Genotype”. Exp Clin Transplant 2011; 1: 7-13.\cr
#' \cr
#' Background\cr
...
#' N = 64 subjects,  26 variables\cr
#' \cr
#'
#' @format A data frame with 64 rows and 26 variables
#' \describe{
#' \item{\code{Cancer diagnosis}}{type: character, levels: 13}
