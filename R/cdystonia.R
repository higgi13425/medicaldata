...
#'
#' @description
#' Longitudinal results of a randomized, placebo-controlled trial of botulinum toxin type B (BotB) in 109 subjects across 9 sites. (**more details** available below the variable definitions). \cr
#'
#' @details
...
#' 109 subjects across 9 sites were randomized to placebo (N = 36), 5000 units of botulinum toxin B (N = 36), or 10,000 units of botulinum toxin B (N = 37), injected once at baseline into the affected muscle to partially paralyze it and make it relax, releasing the spasmed side of the neck and head.\cr
...
#'   \item{treat}{treatment assignment: levels: 1 = placebo, 2 = botox B 5000 units, 3 = botox B 10,000 units; type: double 1-3)}
