...
#' The primary analysis task is to classify viral (abm = 0) vs. bacterial (abm = 1) cases, as published in _Spanos A, Harrell FE, Durack DT (1989): Differential diagnosis of acute meningitis: An analysis of the predictive value of initial observations. JAMA 262: 2700-2707._ There are data on 581 patients, with typical levels of missing data in clincial observational studies done in the days of paper charts, so you may choose to impute some of the missing data. Some of the variables in the published paper need to be derived, including the CSF to blood glucose ratio, and the number of months from peak of summer (in North Carolina, in the Northern Hemisphere). In addition to imputation, modern machine learning classification techniques can be applied and compared to logistic regression.
#'  \cr
#'  \cr
...
#' }
#'
#' @source This data set is provided generously by Frank Harrell, from his website \href{https://hbiostat.org/data/}{here}, as the dataset "abm". These data were published as _Spanos A, Harrell FE, Durack DT (1989): Differential diagnosis of acute meningitis: An analysis of the predictive value of initial observations. JAMA 262: 2700-2707_, which can be found [here](https://jamanetwork.com/journals/jama/article-abstract/379473).
#'
"abm"
