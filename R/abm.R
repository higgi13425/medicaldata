...
#'
#' @description
#' This dataset is a subset of data from a Duke University study of acute meningitis, as provided by Frank Harrell at hbiostat.org/data. The patients were found to have clinical symptoms of meningitis, which include a painful, stiff neck with limited range of motion (limited by pain), headache, light sensitivity, high fever, confusion, and lethargy. This can progress rapidly, and be fatal. A bacterial meningitis can be treated with antibiotics, if given early. These are unnecessary and unhelpful in viral meningitis, and can cause allergic reactions or other adverse events in some patients. Clinically, viral and bacterial meningitis have very similar symptoms, due to the common cause of inflammation of the meninges, the three membranous layers that protect the brain and spinal cord. A spinal tap can be performed to obtain cerebrospinal fluid (CSF) for analysis to help classify cases as bacterial or viral in origin. \cr
#' Timely classification and early treatment of bacterial meningitis can be life-saving. \cr
#' @details
#' Bacterial meningitis occurs in 1 in 100,000 people per year in the United States, most commonly in people between 16 and 23 years old, with additional age peaks in infants and young children, and the elderly. Early symptoms include headache, fever, and pinprick rash of reddish-purple tiny spots. The peak season for bacterial meningitis is in dry winter months in each hemisphere. Bacterial meningitis has a fatality rate of 15-20%, which is higher in the elderly. Untreated bacterial meningitis due to Streptococcus pneumoniae or H. influenzae approaches 100% mortality. \cr\cr
#' Viral meningitis generally resolves with supportive care, but bacterial meningitis requires early use of antibiotic therapy. A subset of patients will require a head CT (computed tomography) scan before a lumbar puncture to obtain CSF, which must occur before antibiotics are given. The CSF (cerebrospinal fluid) is sent to the lab for cell count and differential, glucose, protein, gram stain, and culture. Characteristic findings in bacterial meningitis include low CSF glucose, a low CSF to serum glucose ratio, high CSF protein, and a high CSF white blood cell count, usually composed of neutrophils . However, the spectrum of CSF values in bacterial meningitis is so wide that any one of these findings is of little value. \cr\cr
#' Empiric treatment with antibiotics is begun as soon as the CSF reaches the lab, often with a combination of ceftriaxone plus vancomycin, and ampicillin is added in the elderly to cover Listeria. Meropenem is often used in the immunocompromised for broader coverage including Listeria and Pseudomonas.\cr\cr
...
#'  \cr
#'  \cr
#' @format A data frame with 581 observations and 22 variables
#' \describe{
...
#'   \item{gram}{gram stain result, values 0-6; type: double}
#'   \item{csf_cult}{result of csf culture for bacterial growth, values 0-6; type: double}
#'   \item{blood_cult}{result of blood culture for bacterial growth, values 0-6, 11; type: double}
#'   \item{subset}{subset, training = 1 or test = 2; type: double}
#'   \item{abm}{the outcome variable, acute bacterial meningitis, 0 = absent or 1 = present; type: double}
#' }
#'
#' @source This data set is provided generously by Frank Harrell, from his website \href{https://hbiostat.org/data/}{here}, as the dataset "abm". These data were published as Spanos A, Harrell FE, Durack DT (1989): Differential diagnosis of acute meningitis: An analysis of the predictive value of initial observations. JAMA 262: 2700-2707, which can be found [here](https://jamanetwork.com/journals/jama/article-abstract/379473).
#'
"abm"
