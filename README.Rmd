...
## List of Datasets
Click on links below for more details about the variables included in the dataset in the Codebook, and details about the dataset itself in the Description Document. Note that each dataset also has a help file that you can use within R or RStudio, by entering `help("dataset_name")` in the Console pane.
